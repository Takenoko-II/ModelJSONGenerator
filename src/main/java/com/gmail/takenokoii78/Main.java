...
public class Main {
    ...
    public static @NotNull Path replaceAt(@NotNull Path path, int index, @NotNull String replacement) {
    ...
    private static boolean createItemModelJSON(@NotNull Path inDir, @NotNull TypedJSONArray<JSONObject> cases) {
        ...
        notes.add("For example, 'PATH' will be 'knight_slash/normal_combo1/frame1'.");
